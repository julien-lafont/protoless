...
// source: modules/tests/src/main/protobuf/schemas.proto
...
public final class Schemas {
  ...
  public interface NestedOrBuilder extends
    ...
    /**
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    boolean hasM();
    /**
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    io.protoless.tests.samples.Schemas.Custom getM();
    /**
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    io.protoless.tests.samples.Schemas.CustomOrBuilder getMOrBuilder();

    /**
     * <code>repeated .io.protoless.tests.samples.Custom rm = 3;</code>
     */
  ...
  public  static final class Nested extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              m_ = input.readMessage(io.protoless.tests.samples.Schemas.Custom.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    private io.protoless.tests.samples.Schemas.Custom m_;
    /**
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    public boolean hasM() {
     ...
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    public io.protoless.tests.samples.Schemas.Custom getM() {
      return m_ == null ? io.protoless.tests.samples.Schemas.Custom.getDefaultInstance() : m_;
    }
    /**
     * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
     */
    public io.protoless.tests.samples.Schemas.CustomOrBuilder getMOrBuilder() {
      return getM();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (m_ != null) {
        output.writeMessage(2, getM());
      }
      for (int i = 0; i < rm_.size(); i++) {
        output.writeMessage(3, rm_.get(i));
      }
      if (b_ != false) {
    ...
    public int getSerializedSize() {
      ...
      if (m_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, getM());
      }
      for (int i = 0; i < rm_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, rm_.get(i));
      }
      if (b_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      private io.protoless.tests.samples.Schemas.Custom m_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          io.protoless.tests.samples.Schemas.Custom, io.protoless.tests.samples.Schemas.Custom.Builder, io.protoless.tests.samples.Schemas.CustomOrBuilder> mBuilder_;
      /**
       * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
       */
      public boolean hasM() {
       ...
       * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
       */
      public Builder setM(io.protoless.tests.samples.Schemas.Custom value) {
        if (mBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
       */
      public Builder mergeM(io.protoless.tests.samples.Schemas.Custom value) {
        if (mBuilder_ == null) {
          if (m_ != null) {
            m_ =
              io.protoless.tests.samples.Schemas.Custom.newBuilder(m_).mergeFrom(value).buildPartial();
          } else {
            m_ = value;
          }
          onChanged();
       ...
       * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
       */
      public io.protoless.tests.samples.Schemas.Custom.Builder getMBuilder() {
      ...
      public io.protoless.tests.samples.Schemas.CustomOrBuilder getMOrBuilder() {
        if (mBuilder_ != null) {
          ...
          return m_ == null ?
              io.protoless.tests.samples.Schemas.Custom.getDefaultInstance() : m_;
        }
      }
      /**
       * <code>optional .io.protoless.tests.samples.Custom m = 2;</code>
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-modules/tests/src/main/protobuf/schema" +
      "s.proto\022\032io.protoless.tests.samples\"\214\003\n\010" +
      ...
      "\013bytes_field\030\017 \001(\014\0226\n\013color_field\030\020 \001(\0162" +
      "!.io.protoless.tests.samples.Color\"\214\003\n\010R" +
      ...
      "bytes_field\030\017 \003(\014\0226\n\013color_field\030\020 \003(\0162!" +
      ".io.protoless.tests.samples.Color\"\262\003\n\005On" +
      "eOf\022\026\n\014double_field\030\001 \001(\001H\000\022\025\n\013float_fie" +
      "ld\030\002 \001(\002H\000\022\025\n\013int32_field\030\003 \001(\005H\000\022\025\n\013int" +
      "64_field\030\004 \001(\003H\000\022\026\n\014uint32_field\030\005 \001(\rH\000" +
      "\022\026\n\014uint64_field\030\006 \001(\004H\000\022\026\n\014sint32_field" +
      "\030\007 \001(\021H\000\022\026\n\014sint64_field\030\010 \001(\022H\000\022\027\n\rfixe" +
      "d32_field\030\t \001(\007H\000\022\027\n\rfixed64_field\030\n \001(\006" +
      "H\000\022\030\n\016sfixed32_field\030\013 \001(\017H\000\022\030\n\016sfixed64" +
      "_field\030\014 \001(\020H\000\022\024\n\nbool_field\030\r \001(\010H\000\022\026\n\014",
      "string_field\030\016 \001(\tH\000\022\025\n\013bytes_field\030\017 \001(" +
      "\014H\000\0228\n\013color_field\030\020 \001(\0162!.io.protoless." +
      "tests.samples.ColorH\000B\007\n\005field\"W\n\006Custom" +
      "\022\014\n\004uuid\030\001 \001(\t\022\022\n\nbigdecimal\030\002 \001(\t\022\016\n\006bi" +
      "gint\030\003 \001(\t\022\r\n\005short\030\004 \001(\005\022\014\n\004char\030\005 \001(\005\"" +
      "}\n\006Nested\022\t\n\001d\030\001 \001(\001\022-\n\001m\030\002 \001(\0132\".io.pro" +
      "toless.tests.samples.Custom\022.\n\002rm\030\003 \003(\0132" +
      "\".io.protoless.tests.samples.Custom\022\t\n\001b" +
